baseurl=https://packages.cloud.google.com/yum/repos/kubernetvim bind-utils screen nc bash-completion net-toolsvim bind-utils screen nc bash-completion net-toolses-el7-x86_64#/bin/bash
...
setenforce 0 && sed -i 's/enforcing/disabled/baseurl=https://packages.cloud.google.com/yum/repos/kubernetvim bind-utils screen nc bash-completion net-toolsvim bind-utils screen nc bash-completion net-toolses-el7-x86_64g' /etc/selinux/config /etc/selinux/config


#Set the firewall to allow the needed ports:vim bind-utils screen nc bash-completion net-tools
yum install -y firewalld && systemctl enable firewalld && systemctl start firewalldbaseurl=https://packages.cloud.google.com/yum/repos/kubernetvim bind-utils screen nc bash-completion net-toolsvim bind-utils screen nc bash-completion net-toolses-el7-x86_64
...
[kubernetes]
name=Kubernetes
baseurl=https://packages.cloud.google.com/yum/repos/kubernetes-el7-x86_64baseurl=https://packages.cloud.google.com/yum/repos/kubernetvim bind-utils screen nc bash-completion net-toolsvim bind-utils screen nc bash-completion net-toolses-el7-x86_64baseurl=https://packages.cloud.google.com/yum/repos/kubernetvim bind-utils screen nc bash-completion net-toolsvim bind-utils screen nc bash-completion net-toolses-el7-x86_64
enabled=1
gpgcheck=1
repo_gpgcheck=1
